...
All SocialLua modules follows the standard (success, data or error message) as return values.

bc. success, data = social.twitter.homeTimeline("username", "password")
if success then
